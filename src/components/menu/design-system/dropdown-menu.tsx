...
export const DropdownMenuItem = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.Item>) => <DropdownMenu.Item {...props} style={{ height: 34 }} />,
  "Item",
);

export const DropdownMenuItemTitle = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.ItemTitle>) => <DropdownMenu.ItemTitle {...props} />,
  "ItemTitle",
);

export const DropdownMenuItemIcon = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.ItemIcon>) => <DropdownMenu.ItemIcon {...props} />,
  "ItemIcon",
);

export const DropdownMenuItemImage = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.ItemImage>) => <DropdownMenu.ItemImage {...props} />,
  "ItemImage",
);
...
export const DropdownMenuSeparator = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.Separator>) => <DropdownMenu.Separator {...props} />,
  "Separator",
);
...
export const DropdownMenuCheckboxItem = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.CheckboxItem>) => (
    <DropdownMenu.CheckboxItem {...props} style={{ ...props.style, display: "flex", alignItems: "center", gap: 8 }}>
...
export const DropdownMenuSubTrigger = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.SubTrigger>) => <DropdownMenu.SubTrigger {...props} />,
  "SubTrigger",
);

export const DropdownMenuSubContent = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.SubContent>) => <DropdownMenu.SubContent {...props} />,
  "SubContent",
);
...
export const DropdownMenuItemIndicator = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.ItemIndicator>) => <DropdownMenu.ItemIndicator {...props} />,
  "ItemIndicator",
);

export const DropdownMenuPreview = DropdownMenu.create(
  (props: React.ComponentProps<typeof DropdownMenu.Preview>) => <DropdownMenu.Preview {...props} />,
  "Preview",
);
